...
loginFormElement.addEventListener('submit', function(event) {
  ...
  /**
  *Membuat variabel email untuk menyimpan nilai email yang didapat saat button di tekan.
  *@constant {string}
  */
  const email = inputEmailElement.value;
  /**
  *Membuat variabel password untuk menyimpan nilai password yang didapat saat button di tekan.
  *@constant {string}
  */
